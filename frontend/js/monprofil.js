...
axios.get("http://localhost:3008/api/user/post/", headers)
    .then((data) => {
...
form.addEventListener('submit', function (e) {
    ...
    axios.put("http://localhost:3008/api/user/profil/", data, headers).then(() => {
...
deleteAccount.addEventListener('click', () => {
    axios.delete("http://localhost:3008/api/user/profil/", headers).then(() => {
        window.location.href = 'login.html'
    })
})
